                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="<?= base_url(); ?>/coordinator/datatransaksi/logcicilan" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Data</a>
                            <a href="<?= base_url('coordinator/admincontrollers/exportfileexcellogcicilan') ?>" class="btn btn-primary"><i class="fas fa-download"></i> Export Data</a>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                foreach ($tb_log_cicilan as $log_cicilan) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <!-- <a href="<?= base_url('coordinator/datatransaksi/logcicilan/' . $log_cicilan['l_id'] . '/edit') ?>" class="btn btn-warning btn-sm"><i class="fas fa-pencil-alt"></i></a> -->
                                            <a href="#" data-href="<?= base_url('coordinator/datatransaksi/logcicilan/' . $log_cicilan['l_id'] . '/delete') ?>" onclick="confirmToDelete(this)" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php $i++;
                                endforeach ?>
