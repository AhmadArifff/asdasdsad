...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="<?= base_url(); ?>/admin/datatransaksi/datacicilan">Data Cicilan Pembayaran</a></div>
            ...
            <div class="col-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <?= $this->include('admin/DataTransaksi/TransaksiCicilan/importexcelcicilan') ?>
                        <form method="post" action="<?= base_url(); ?>/admin/datatransaksi/cicilan/process">
                            <?= csrf_field(); ?>
                            <div class="row">
