                            ...
                            <tbody>
                                ...
                                foreach ($tb_user as $user) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('admin/databaseuser/datauser/' . $user['u_id'] . '/edit') ?>" class="btn btn-warning btn-sm"><i class="fas fa-pencil-alt"></i></a>
                                            <a href="#" data-href="<?= base_url('admin/databaseuser/datauser/' . $user['u_id'] . '/delete') ?>" onclick="confirmToDelete(this)" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php $i++;
                                endforeach ?>
