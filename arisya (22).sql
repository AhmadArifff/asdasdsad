...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 12 Bulan Mei 2023 pada 04.30
...
--
-- Struktur dari tabel `tb_alert`
--

CREATE TABLE `tb_alert` (
  `al_id` int(11) NOT NULL,
  `al_nama` varchar(15) NOT NULL,
  `al_due_date` datetime NOT NULL
...
CREATE TABLE `tb_cicilan` (
  ...
  `c_total_cicilan` bigint(255) NOT NULL,
  `c_cicilan_masuk` bigint(255) DEFAULT NULL,
  `c_cicilan_outstanding` bigint(255) DEFAULT NULL,
  `c_total_biaya` bigint(255) NOT NULL,
  `c_biaya_masuk` bigint(255) DEFAULT NULL,
  `c_biaya_outstanding` bigint(255) DEFAULT NULL,
...
INSERT INTO `tb_cicilan` (`c_id`, `u_id`, `p_id`, `t_id`, `pe_id`, `c_total_cicilan`, `c_cicilan_masuk`, `c_cicilan_outstanding`, `c_total_biaya`, `c_biaya_masuk`, `c_biaya_outstanding`, `created_at`) VALUES
(423, 172, 56, 110, 4, 80, 0, 80, 3250000, 0, 3250000, '2023-05-04 07:53:15'),
(424, 171, 57, 109, 6, 36, 36, 0, 660000, 660000, 0, '2023-05-04 07:53:26'),
(426, 177, 56, 112, 4, 80, 0, 80, 3250000, 0, 3250000, '2023-05-04 14:26:07');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_item_barang`
--

CREATE TABLE `tb_item_barang` (
...
(23, 'SPRIT', 5000, 13, 20, 1, 'botol', 1),
(24, 'COCA-COLA', 5000, 13, 10, 1, 'botol', 1),
(25, 'MINYAK', 7000, 19, 150, 1, 'liter', 1),
(26, 'SNACK', 20000, 13, 200, 5, 'pcs', 1),
(27, 'BERAS', 20000, 6, 4, 1, 'kg', 1);

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_log_cicilan`
--
...
CREATE TABLE `tb_log_cicilan` (
  ...
  `l_approval_date` datetime NOT NULL,
  `l_foto` varchar(255) DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `due_date` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `tb_log_cicilan`
--

INSERT INTO `tb_log_cicilan` (`l_id`, `l_id_sementara`, `u_id`, `c_id`, `t_id`, `l_jumlah_bayar`, `l_jumlah_pembayaran_cicilan`, `l_approval_by`, `l_approval_date`, `l_foto`, `created_at`, `due_date`) VALUES
(51, 40, 171, 424, 109, 500000, 27, 1, '0000-00-00 00:00:00', '1683169335_e3180ee29ff98369acfd.png', '2023-05-04 10:03:43', '2023-05-04 10:03:43'),
(52, 41, 171, 424, 109, 160000, 9, 1, '0000-00-00 00:00:00', '1683169458_b3b75eb1778dc6ede4aa.png', '2023-05-04 10:04:44', '2023-05-04 10:04:44');

--
-- Trigger `tb_log_cicilan`
--
DELIMITER $$
...
--
-- Struktur dari tabel `tb_log_cicilan_sementara`
--

CREATE TABLE `tb_log_cicilan_sementara` (
  `l_id` int(11) NOT NULL,
  `u_id` int(11) NOT NULL,
  `c_id` int(11) NOT NULL,
  `l_jumlah_bayar` bigint(20) NOT NULL,
  `l_jumlah_pembayaran_cicilan` int(11) NOT NULL,
  `l_approval_by` int(11) DEFAULT NULL,
  `l_approval_date` datetime NOT NULL,
  `l_foto` varchar(255) DEFAULT NULL,
...
--
-- Dumping data untuk tabel `tb_log_cicilan_sementara`
--

INSERT INTO `tb_log_cicilan_sementara` (`l_id`, `u_id`, `c_id`, `l_jumlah_bayar`, `l_jumlah_pembayaran_cicilan`, `l_approval_by`, `l_approval_date`, `l_foto`, `created_at`, `due_date`) VALUES
(40, 171, 424, 500000, 27, 1, '0000-00-00 00:00:00', '1683169335_e3180ee29ff98369acfd.png', '2023-05-04 10:02:15', '2023-05-04 10:03:43'),
(41, 171, 424, 160000, 9, 1, '0000-00-00 00:00:00', '1683169458_b3b75eb1778dc6ede4aa.png', '2023-05-04 10:04:19', '2023-05-04 10:04:44');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_packaging`
--

CREATE TABLE `tb_packaging` (
  `pa_id` int(30) NOT NULL,
  `pa_nama` varchar(100) NOT NULL,
  `pa_harga` bigint(255) NOT NULL,
  `pa_foto` varchar(255) DEFAULT NULL,
  `u_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `tb_packaging`
--
...
CREATE TABLE `tb_paket` (
  ...
  `p_hargaJual` bigint(255) NOT NULL,
  `p_hargaBarang` bigint(255) NOT NULL,
  `pa_id` int(11) NOT NULL,
  `p_cashback` bigint(255) NOT NULL,
  `p_insentive` bigint(255) NOT NULL,
  `p_laba` bigint(255) DEFAULT NULL,
  `p_persentaseLaba` varchar(255) NOT NULL,
  `p_setoran` bigint(255) NOT NULL,
  `p_foto` varchar(255) NOT NULL,
  `u_id` int(11) NOT NULL,
  `created_at` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(56, 4, 'PREMIUM', 1625000, 500000, 18, 0, 112500, 1012500, '62.307692307692', 40625, '1683194070_fd918da27aaa10462a24.png', 1, '2023-05-04 16:54:30'),
(57, 6, 'MEDIUM', 220000, 111111, 18, 0, 10889, 98000, '44.5455', 18333, '1683194010_e315a49690cc385e08ba.jpg', 1, '2023-05-07 14:31:35');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_pay_periode`
--

CREATE TABLE `tb_pay_periode` (
  `pe_id` int(11) NOT NULL,
  `pe_nama` varchar(100) NOT NULL,
  `pe_periode` int(11) NOT NULL,
  `u_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `tb_pay_periode`
--

INSERT INTO `tb_pay_periode` (`pe_id`, `pe_nama`, `pe_periode`, `u_id`) VALUES
(4, 'WEEKLY', 40, 1),
(5, 'DAILY', 310, 1),
(6, 'MONTHLY', 12, 1);
...
--
-- Struktur dari tabel `tb_pengambilan_paket`
--

CREATE TABLE `tb_pengambilan_paket` (
...
--
-- Dumping data untuk tabel `tb_pengambilan_paket`
--
...
CREATE TABLE `tb_transaksi` (
  ...
  `t_totalharga` int(11) NOT NULL,
  `waktu` datetime NOT NULL,
  `t_approval_by` int(11) DEFAULT NULL,
...
(106, 171, 56, 4, 2, 3250000, '2023-05-08 13:20:59', NULL, ''),
(109, 171, 57, 6, 3, 660000, '2023-05-04 07:53:26', 1, ''),
(110, 172, 56, 4, 2, 3250000, '2023-05-04 07:53:15', 1, ''),
(111, 172, 57, 6, 3, 660000, '2023-05-04 07:54:16', NULL, ''),
(112, 177, 56, 4, 2, 3250000, '2023-05-04 14:26:07', 1, ''),
(115, 177, 57, 6, 7, 1540000, '2023-05-08 13:18:53', NULL, '');
...
--
-- Dumping data untuk tabel `tb_transaksi_pengambilan_paket`
--

INSERT INTO `tb_transaksi_pengambilan_paket` (`pp_id`, `pp_t_id`, `pp_p_id`, `pp_ib_id`, `pp_qty`, `pp_ktrg_berat_ukuran`) VALUES
(258, 106, 56, 23, 1, 'botol'),
(259, 106, 56, 24, 1, 'botol'),
(260, 106, 56, 25, 1, 'liter'),
(261, 106, 56, 26, 1, 'pcs'),
(262, 106, 56, 23, 1, 'botol'),
(263, 106, 56, 24, 1, 'botol'),
(264, 106, 56, 25, 1, 'liter'),
(265, 106, 56, 26, 1, 'pcs'),
(326, 109, 57, 25, 1, 'liter'),
(327, 109, 57, 27, 1, 'kg'),
(328, 109, 57, 25, 1, 'liter'),
(329, 109, 57, 27, 1, 'kg'),
(330, 109, 57, 25, 1, 'liter'),
(331, 109, 57, 27, 1, 'kg'),
(332, 110, 56, 23, 1, 'botol'),
(333, 110, 56, 24, 1, 'botol'),
(334, 110, 56, 25, 1, 'liter'),
(335, 110, 56, 26, 1, 'pcs'),
(336, 110, 56, 23, 1, 'botol'),
(337, 110, 56, 24, 1, 'botol'),
(338, 110, 56, 25, 1, 'liter'),
(339, 110, 56, 26, 1, 'pcs'),
(340, 111, 57, 25, 1, 'liter'),
(341, 111, 57, 27, 1, 'kg'),
(342, 111, 57, 25, 1, 'liter'),
(343, 111, 57, 27, 1, 'kg'),
(344, 111, 57, 25, 1, 'liter'),
(345, 111, 57, 27, 1, 'kg'),
(346, 112, 56, 23, 1, 'botol'),
(347, 112, 56, 24, 1, 'botol'),
(348, 112, 56, 25, 1, 'liter'),
(349, 112, 56, 26, 1, 'pcs'),
(350, 112, 56, 23, 1, 'botol'),
(351, 112, 56, 24, 1, 'botol'),
(352, 112, 56, 25, 1, 'liter'),
(353, 112, 56, 26, 1, 'pcs'),
(396, 115, 57, 23, 1, 'botol'),
(397, 115, 57, 24, 1, 'botol'),
(398, 115, 57, 25, 1, 'liter'),
(399, 115, 57, 26, 1, 'pcs'),
(400, 115, 57, 23, 1, 'botol'),
(401, 115, 57, 24, 1, 'botol'),
(402, 115, 57, 25, 1, 'liter'),
(403, 115, 57, 26, 1, 'pcs'),
(404, 115, 57, 23, 1, 'botol'),
(405, 115, 57, 24, 1, 'botol'),
(406, 115, 57, 25, 1, 'liter'),
(407, 115, 57, 26, 1, 'pcs'),
(408, 115, 57, 23, 1, 'botol'),
(409, 115, 57, 24, 1, 'botol'),
(410, 115, 57, 25, 1, 'liter'),
(411, 115, 57, 26, 1, 'pcs'),
(412, 115, 57, 23, 1, 'botol'),
(413, 115, 57, 24, 1, 'botol'),
(414, 115, 57, 25, 1, 'liter'),
(415, 115, 57, 26, 1, 'pcs'),
(416, 115, 57, 23, 1, 'botol'),
(417, 115, 57, 24, 1, 'botol'),
(418, 115, 57, 25, 1, 'liter'),
(419, 115, 57, 26, 1, 'pcs'),
(420, 115, 57, 23, 1, 'botol'),
(421, 115, 57, 24, 1, 'botol'),
(422, 115, 57, 25, 1, 'liter'),
(423, 115, 57, 26, 1, 'pcs');
...
CREATE TABLE `tb_user` (
  ...
  `u_role` enum('admin','coordinator','anggota') NOT NULL,
  `u_referensi` int(11) NOT NULL,
  `u_email` varchar(50) NOT NULL,
  `u_create_at` datetime NOT NULL,
  `u_expired_date` datetime DEFAULT NULL,
  `u_nik` varchar(20) NOT NULL,
  `u_nama` varchar(100) NOT NULL,
  `u_tempat_lahir` varchar(100) NOT NULL,
  `u_tanggal_lahir` date NOT NULL,
  `u_jenis_kelamin` enum('Laki-laki','Perempuan') NOT NULL,
  `u_provinsi` varchar(100) DEFAULT NULL,
  `u_kota` varchar(100) DEFAULT NULL,
  `u_kelurahan` varchar(100) NOT NULL,
  `u_kecamatan` varchar(100) DEFAULT NULL,
  `u_kodepos` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tb_user` (`u_id`, `u_username`, `u_password`, `u_fullname`, `u_role`, `u_referensi`, `u_email`, `u_create_at`, `u_expired_date`, `u_nik`, `u_nama`, `u_tempat_lahir`, `u_tanggal_lahir`, `u_jenis_kelamin`, `u_provinsi`, `u_kota`, `u_kelurahan`, `u_kecamatan`, `u_kodepos`) VALUES
(1, 'admin', '$2y$10$Ljr28TtylE10gn/ZRYMu3O8x8X/lJ2mQ5rOChuZYnHQwT5BGjXfxm', 'AHMAD ARIF', 'admin', 1, 'qvftp1223@gmail.com', '2023-03-01 04:42:52', NULL, '2147483647', 'AHMAD ARIF', 'Cimahi', '2023-01-23', 'Laki-laki', '32', '3277', 'Cibeureum', '3277010', '10730'),
...
(171, 'anggotaA', '$2y$10$MfdTzKhC2l44kE0DlqkfvOU9qfNzMRDDXkCAjrhpx3q/i8/xLox8u', 'ANGGOTAA', 'anggota', 2, 'anggotaA@gmail.com', '2023-05-12 09:25:13', '2023-05-12 09:25:38', '2222222222222222', 'ANGGOTAA', 'CIMAHI', '2023-01-01', 'Laki-laki', '12', '1201', 'Cibeureum', '1201061', '40534'),
...
ALTER TABLE `tb_cicilan`
  ...
  ADD KEY `u_id` (`u_id`,`p_id`,`t_id`,`pe_id`),
  ADD KEY `p_id` (`p_id`),
  ADD KEY `t_id` (`t_id`),
  ADD KEY `pe_id` (`pe_id`);

--
-- Indeks untuk tabel `tb_item_barang`
--
...
--
-- Indeks untuk tabel `tb_log_cicilan`
--
...
ALTER TABLE `tb_log_cicilan_sementara`
  ADD PRIMARY KEY (`l_id`),
  ADD KEY `u_id` (`u_id`,`c_id`,`l_approval_by`),
  ADD KEY `l_approval_by` (`l_approval_by`),
  ADD KEY `c_id` (`c_id`);

--
-- Indeks untuk tabel `tb_packaging`
--
...
ALTER TABLE `tb_paket`
  ...
  ADD KEY `pa_id` (`pa_id`),
  ADD KEY `u_id` (`u_id`),
  ADD KEY `pe_id_2` (`pe_id`);

--
-- Indeks untuk tabel `tb_pay_periode`
--
ALTER TABLE `tb_pay_periode`
  ADD PRIMARY KEY (`pe_id`),
  ADD KEY `u_id` (`u_id`);

--
-- Indeks untuk tabel `tb_pengambilan_paket`
--
...
ALTER TABLE `tb_transaksi`
  ...
  ADD KEY `p_id` (`p_id`),
  ADD KEY `t_approval_by` (`t_approval_by`),
  ADD KEY `pe_id` (`pe_id`);
...
ALTER TABLE `tb_user`
  ...
  ADD KEY `u_referensi` (`u_referensi`);
...
--
-- AUTO_INCREMENT untuk tabel `tb_alert`
--
ALTER TABLE `tb_alert`
...
--
ALTER TABLE `tb_cicilan`
  MODIFY `c_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=429;
...
--
ALTER TABLE `tb_packaging`
  MODIFY `pa_id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `tb_pengambilan_paket`
  MODIFY `pp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;

--
-- AUTO_INCREMENT untuk tabel `tb_transaksi`
--
ALTER TABLE `tb_transaksi`
  MODIFY `t_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=116;

--
-- AUTO_INCREMENT untuk tabel `tb_transaksi_pengambilan_paket`
--
ALTER TABLE `tb_transaksi_pengambilan_paket`
  MODIFY `pp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=424;

--
-- AUTO_INCREMENT untuk tabel `tb_user`
--
ALTER TABLE `tb_user`
  MODIFY `u_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=180;
...
--
ALTER TABLE `tbl_kabupaten`
  ADD CONSTRAINT `tbl_kabupaten_ibfk_1` FOREIGN KEY (`id_provinsi`) REFERENCES `tbl_provinsi` (`id_provinsi`);
...
--
-- Ketidakleluasaan untuk tabel `tb_cicilan`
--
ALTER TABLE `tb_cicilan`
  ADD CONSTRAINT `tb_cicilan_ibfk_3` FOREIGN KEY (`t_id`) REFERENCES `tb_transaksi` (`t_id`),
  ADD CONSTRAINT `tb_cicilan_ibfk_5` FOREIGN KEY (`u_id`) REFERENCES `tb_user` (`u_id`),
  ADD CONSTRAINT `tb_cicilan_ibfk_6` FOREIGN KEY (`p_id`) REFERENCES `tb_paket` (`p_id`),
  ADD CONSTRAINT `tb_cicilan_ibfk_7` FOREIGN KEY (`pe_id`) REFERENCES `tb_pay_periode` (`pe_id`);

--
-- Ketidakleluasaan untuk tabel `tb_item_barang`
--
ALTER TABLE `tb_item_barang`
  ADD CONSTRAINT `tb_item_barang_ibfk_1` FOREIGN KEY (`u_id`) REFERENCES `tb_user` (`u_id`);

--
-- Ketidakleluasaan untuk tabel `tb_log_cicilan`
--
ALTER TABLE `tb_log_cicilan`
...
--
ALTER TABLE `tb_log_cicilan_sementara`
  ADD CONSTRAINT `tb_log_cicilan_sementara_ibfk_1` FOREIGN KEY (`u_id`) REFERENCES `tb_user` (`u_id`),
  ADD CONSTRAINT `tb_log_cicilan_sementara_ibfk_2` FOREIGN KEY (`l_approval_by`) REFERENCES `tb_user` (`u_id`),
  ADD CONSTRAINT `tb_log_cicilan_sementara_ibfk_3` FOREIGN KEY (`c_id`) REFERENCES `tb_cicilan` (`c_id`);

--
-- Ketidakleluasaan untuk tabel `tb_packaging`
--
ALTER TABLE `tb_packaging`
  ADD CONSTRAINT `tb_packaging_ibfk_1` FOREIGN KEY (`u_id`) REFERENCES `tb_user` (`u_id`);

--
-- Ketidakleluasaan untuk tabel `tb_paket`
--
ALTER TABLE `tb_paket`
  ADD CONSTRAINT `tb_paket_ibfk_3` FOREIGN KEY (`u_id`) REFERENCES `tb_user` (`u_id`),
  ADD CONSTRAINT `tb_paket_ibfk_4` FOREIGN KEY (`pa_id`) REFERENCES `tb_packaging` (`pa_id`),
  ADD CONSTRAINT `tb_paket_ibfk_5` FOREIGN KEY (`pe_id`) REFERENCES `tb_pay_periode` (`pe_id`);

--
-- Ketidakleluasaan untuk tabel `tb_pay_periode`
--
ALTER TABLE `tb_pay_periode`
  ADD CONSTRAINT `tb_pay_periode_ibfk_1` FOREIGN KEY (`u_id`) REFERENCES `tb_user` (`u_id`);
...
--
ALTER TABLE `tb_transaksi`
  ADD CONSTRAINT `tb_transaksi_ibfk_3` FOREIGN KEY (`t_approval_by`) REFERENCES `tb_user` (`u_id`),
...
--
ALTER TABLE `tb_user`
  ADD CONSTRAINT `tb_user_ibfk_1` FOREIGN KEY (`u_referensi`) REFERENCES `tb_user` (`u_id`);
COMMIT;
